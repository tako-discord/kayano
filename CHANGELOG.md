...
## [1.6.0](https://github.com/kayano-bot/kayano/compare/v1.6.0-alpha...v1.6.0) (2021-11-22)
...
## [1.6.0-alpha](https://github.com/kayano-bot/kayano/compare/v1.5.1-alpha...v1.6.0-alpha) (2021-11-22)
### Features
...
* **readme**: added contribution guidelines ([0c21fb0](https://github.com/kayano-bot/kayano/commit/c884f962f8547ea324e1e015c9b47978bdff1fa3))
...
### Fixed
* Bot crashes when using a command that the bot does not have permission for (`ban`, `kick` etc.)
* Some general security issues with `kick` & `ban` command
### Known Issues
* `kick` and `ban` says she kicked *undefined* even though she kicked the person you specified

## [1.4.4-alpha] (2021-11-15)
### Added
* `vote` command (customizable in `config.js`)
* Links in CHANGELOG for ^1.4.0

## [1.4.3-alpha] (2021-11-14)
### Added
* Error handler for `lyrics` because it often causes errors
...
### Fixed
* Wrong date in CHANGELOG for `v1.4.0-alpha`
...
[1.5.1-alpha]: https://github.com/kayano-bot/kayano/compare/v1.5.0-alpha...v1.5.1-alpha
...
[1.4.1-alpha]: https://github.com/kayano-bot/kayano/compare/v1.4.0-alpha...v1.4.1-alpha
